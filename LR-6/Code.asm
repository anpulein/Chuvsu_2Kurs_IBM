...
;ющий сегмент текстового  видеобуфера.  Таблица  IDT содержит 16
...
;    Проиллюстрируем все вышесказанное на примере программы, вы-
;полняющей переход в защищенный режим, простейшие действия с эк-
;раном и возврат в реальный режим. Рассмотрим  работу программы:
;    - Формируем в памяти таблицы GDT и IDT.  GDT содерж