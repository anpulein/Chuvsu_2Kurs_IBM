...
;-----------------------------------R------------------------------------------;
		...
		R2:
			...
			je II1 ; Если R отжали,то идем дальше 
...
;-----------------------------------I------------------------------------------;
		...
		II1:
			in AL,60h 
			cmp AL,17h ; Скан код нажатия буквы I
			je II2 ; Если I идем на проверку отжатия
			cmp AL, 93h ; Если не I идем на проверку того что пользователь не нажимал
			je II1 
			jmp R1 
		...
		II2:
			in AL,60h 
			cmp AL,97h ; Скан код отжатия буквы I
			je Y1 ; Если I отжали,то идем дальше 
			jmp II2 ; Если кнопка еще не отжата ждем отжатия
...
;-----------------------------------Y------------------------------------------;
		...
		Y1:
			...
			cmp AL, 97h ; Если не Y идем на проверку того что пользователь не нажимал
			je Y1 
			jmp II1 
